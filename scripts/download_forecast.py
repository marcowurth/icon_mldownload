...
def interpolate_icosahedral_to_latlon(path, merged_filename, latlon_filename, latlon_resolution,
                                      model, output_as_netcdf):

    # interpolates icosahedral to regular latlon grid and save as netcdf4 file #
